...
public class ExemploTreeMap {
    ...
    public static void main(String args[]) {
        ...
        exemploListaSimplesIterandoChavesValor();
    ...
    private static void exemploListaSimplesIterandoChavesValor() {
        System.out.println("* exemploListaSimplesIterandoChavesValor *");
        Map<Integer, String> lista = new TreeMap<>();
        lista.put(1, "João da Silva");
        lista.put(2, "Antonio Sousa");
        lista.put(3, "Lúcia Ferreira");
        ...
        for (Map.Entry<Integer, String> e : entry) {
            ...
            System.out.println("Valor: " + e.getKey());
        }
    ...
    private static void exemploListaSimplesIterandoValores() {
        System.out.println("******* exemploListaSimpleIterandoValores *******");
        Map<Integer, String> lista = new TreeMap<>();
        lista.put(1, "João da Silva");
        lista.put(2, "Antonio Sousa");
        lista.put(3, "Lúcia Ferreira");
